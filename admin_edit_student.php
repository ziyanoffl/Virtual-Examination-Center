       ...
       <br>
        ...
        <section class="page-section" id="student_registration">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mt-5">Edit Student Profile</h2>
                <!-- Icon Divider-->
                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <form class="mt-5" id="contactForm" method="post" >
                            ...
                            <div class="form-floating mb-3">
                                <input name="txtname" class="form-control" id="" type="txt" placeholder="name@example.com"  value="<?php echo $name ?>"/>
                                <label for="txtname">Name</label>
                            </div>

                             <!-- Address input-->
                             <div class="form-floating mb-3">
                                <input name="txtaddress" class="form-control" id="" type="txt" placeholder="name@example.com" value="<?php echo $address ?>" />
                                <label for="txtaddress">Address</label>
                            </div>

                             <!-- Date of birth input-->
                             <div class="form-floating mb-3">
                                <input name="txtdob" class="form-control" id="" type="date" placeholder="name@example.com"  value="<?php echo $dob ?>"/>
                                <label for="txtdob">Date of birth</label>
                            </div>

                            <!-- Email input -->
                            <div class="form-floating mb-3">
                                <input name="txtemail" class="form-control" id="" type="email" placeholder="xxxxxxx" value="<?php echo $email ?>" />
                                <label for="txtemail">Email</label>
                            </div>

                            <!-- Password input-->
                            <div class="form-floating mb-3">
                                <input name="txtpassword" class="form-control" id="" type="password" placeholder="name@example.com" value="<?php echo $password ?>" />
